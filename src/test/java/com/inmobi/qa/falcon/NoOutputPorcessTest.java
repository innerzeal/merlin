...
public class NoOutputPorcessTest {
	...
	public void checkForJMSMsgWhenNoOutput() throws Exception{
		...
		try{
			...
			Util.print("attaching consumer to:   "+"IVORY.ENTITY.TOPIC");
			Consumer consumer=new Consumer("IVORY.ENTITY.TOPIC",ivoryqa1.getClusterHelper().getActiveMQ());
	        consumer.start();
			Thread.sleep(15000);
	...
	@Test(enabled=true)
	public void checkForJMSMsgWithOutput() throws Exception{
		...
		try{
			...
			Consumer consumerInternalMsg=new Consumer("IVORY.ENTITY.TOPIC",ivoryqa1.getClusterHelper().getActiveMQ());
			Consumer consumerProcess=new Consumer("IVORY."+b.getProcessName(),ivoryqa1.getClusterHelper().getActiveMQ());
