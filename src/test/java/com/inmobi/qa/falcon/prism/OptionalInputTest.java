...
public class OptionalInputTest {
	...
	@Test(enabled=false)
	public void optionalTest_2optional_2compulsary(){
		
	}
	
	@Test(enabled=false)
	public void optionalTest_optionalInputMissing(){
	...
	@Test(enabled=false)
	public void optionalTest_optionalInputWithSUCCESS(){
		
	}
	
	@Test(enabled=false)
	public void optionalTest_optionalInputWithoutSUCCESS(){
	...
	@Test(enabled=false)
	public void optionalTest_setOptionalToFalse(){
