...
/*			r= prismHelper.getFeedHelper().schedule(URLS.SCHEDULE_URL, feed);
	...
	public void normalTest_2s1t_pt() throws Exception{
		...
		try{
			...
			//clean target if old data exists
			String prefix = "/data/fetlrc/billing/";
			Util.HDFSCleanup(ua1,prefix.substring(1));
			Util.HDFSCleanup(ua2,prefix.substring(1));
	...
	public void normalTest_1s2t_ps() throws Exception{
		...
		try{
			...
			feed = instanceUtil.setFeedCluster(feed,xmlUtil.createValidity(startTimeUA1,"2012-10-01T12:10Z"),xmlUtil.createRtention("days(10000)",ActionType.DELETE),Util.readClusterName(b1.getClusters().get(0)),ClusterType.TARGET,null,"/localDC/rc/billing/ua1/${YEAR}/${MONTH}/${DAY}/${HOUR}/${MINUTE}/");
			feed = instanceUtil.setFeedCluster(feed,xmlUtil.createValidity(startTimeUA2,"2012-10-01T12:25Z"),xmlUtil.createRtention("days(10000)",ActionType.DELETE),Util.readClusterName(b2.getClusters().get(0)),ClusterType.TARGET,null,"/localDC/rc/billing/ua2/${YEAR}/${MONTH}/${DAY}/${HOUR}/${MINUTE}/");
	...
	public void normalTest_2s1t_ps() throws Exception{
		...
		try{
			...
			ArrayList<Path> ua2ReplicatedData =hadoopUtil.getAllFilesRecursivelyHDFS(ua2, new Path("/clusterPath/localDC/rc/billing/ua2/2012/10/01/12/"));
			AssertUtil.failIfStringFoundInPath(ua2ReplicatedData,"ua2");


		
		
			ArrayList<Path> ua2ReplicatedData00ua1 =hadoopUtil.getAllFilesRecursivelyHDFS(ua2, new Path("/clusterPath/localDC/rc/billing/ua2/2012/10/01/12/00/ua1"),"_SUCCESS");
			ArrayList<Path> ua2ReplicatedData05ua3 =hadoopUtil.getAllFilesRecursivelyHDFS(ua2, new Path("/clusterPath/localDC/rc/billing/ua2/2012/10/01/12/05/ua3/"),"_SUCCESS");
	...
	@Test(enabled=false)
	public void normalTest_2s1t_pst() throws Exception{
		
	}
	
	@Test(enabled=false)
	public void normalTest_1s1t1n_pstn() throws Exception{
		
	}
	
	@Test(enabled=false)
	public void emptyPartition() throws Exception{
		
	}
	
	@Test(enabled=false)
	public void nullPartition() throws Exception{
	...
	@Test(enabled=false)
	public void baseDirMissing() throws Exception{
