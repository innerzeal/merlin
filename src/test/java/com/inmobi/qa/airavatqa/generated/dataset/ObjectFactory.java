 ...
 * generated in the uri.ivory.dataset._0 package. 
...
public class ObjectFactory {
    ...
    private final static QName _IgnorePolicies_QNAME = new QName("uri:ivory:dataset:0.1", "IgnorePolicies");
    ...
    private final static QName _DataInputFormat_QNAME = new QName("uri:ivory:dataset:0.1", "DataInputFormat");
    ...
    private final static QName _DataOutputFormat_QNAME = new QName("uri:ivory:dataset:0.1", "DataOutputFormat");
    private final static QName _CredentialProvider_QNAME = new QName("uri:ivory:dataset:0.1", "CredentialProvider");
    private final static QName _PartitionKey_QNAME = new QName("uri:ivory:dataset:0.1", "PartitionKey");
    private final static QName _SortKey_QNAME = new QName("uri:ivory:dataset:0.1", "SortKey");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: uri.ivory.dataset._0
     * 
     */
    ...
    public JAXBElement<String> createIgnorePolicies(String value) {
