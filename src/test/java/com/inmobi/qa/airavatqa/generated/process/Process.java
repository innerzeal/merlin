 ...
 *       &lt;sequence>
 *         &lt;element name="clusters" type="{uri:ivory:process:0.1}clusters"/>
 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="order" type="{uri:ivory:process:0.1}execution-type"/>
 *         &lt;element name="timeout" type="{uri:ivory:process:0.1}frequency-type" minOccurs="0"/>
 *         &lt;element name="frequency" type="{uri:ivory:process:0.1}frequency-type"/>
 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="inputs" type="{uri:ivory:process:0.1}inputs" minOccurs="0"/>
 *         &lt;element name="outputs" type="{uri:ivory:process:0.1}outputs" minOccurs="0"/>
 *         &lt;element name="properties" type="{uri:ivory:process:0.1}properties" minOccurs="0"/>
 *         &lt;element name="workflow" type="{uri:ivory:process:0.1}workflow"/>
 *         &lt;element name="retry" type="{uri:ivory:process:0.1}retry" minOccurs="0"/>
 *         &lt;element name="late-process" type="{uri:ivory:process:0.1}late-process" minOccurs="0"/>
 *       &lt;/sequence>
