...
// */
//public class MonthlyDataWithGapsRetentionTest {
//    
//    Consumer consumer;
...
//    public void test24MonthsRetentionOnFullPathAndMonthlyData(Bundle bundle) throws Exception
//    {
//        try {
...
//        Util.replenishData(Util.getMonthlyDatesOnEitherSide(36,5));
//        
//        
...
//    
//    @Test(groups = {"0.1","0.2"},dataProvider="DP",priority=-1)
//    public void test1MonthRetentionOnFullPathAndMonthlyData(Bundle bundle) throws Exception
//    {
//        try {
//        //make sure the feed has full path
//        String feed=setFeedPathValue(Util.getInputFeedFromBundle(bundle),"/retention/testFolders/${YEAR}/${MONTH}");
...
//        
//        //create data in cluster
//        Util.replenishData(Util.getMonthlyDatesOnEitherSide(10,2));
...
//        
//        //create data in cluster
//        //Util.replenishData(Util.getMonthlyDatesOnEitherSide(2,1));
//        
...
//    
//    @Test(groups = {"0.1","0.2"},dataProvider="DP",priority=-1)
//    public void test30DayRetentionOnFullPathAndMissingDailyData(Bundle bundle) throws Exception
//    {
//        try {
//        //make sure the feed has full path
//        String feed=setFeedPathValue(Util.getInputFeedFromBundle(bundle),"/retention/testFolders/${YEAR}/${MONTH}");
//        //put the desired interval in the feed
//        feed=Util.insertRetentionValueInFeed(feed,"days(30)");
//        bundle.getDataSets().remove(Util.getInputFeedFromBundle(bundle));
//        bundle.getDataSets().add(feed);
//        bundle.generateUniqueBundle();
//        
...
//        
//        //create data in cluster
//        Util.replenishData(Util.getMonthlyDatesOnEitherSide(4,1));
//        
//        Util.CommonDataRetentionWorkflow(bundle,30,"days");
//        }
//        catch(Exception e)
//        {
//            e.printStackTrace();
...
//    
//    @Test(groups = {"0.1","0.2"},dataProvider="DP",priority=-1)
//    public void test1DayRetentionOnFullPathAndMonthlyData(Bundle bundle) throws Exception
//    {
//        try {
//        //make sure the feed has full path
//        String feed=setFeedPathValue(Util.getInputFeedFromBundle(bundle),"/retention/testFolders/${YEAR}/${MONTH}");
...
//        
//        //create data in cluster
//        Util.replenishData(Util.getMonthlyDatesOnEitherSide(3,1));
//        
...
//    
//    @Test(groups = {"0.1","0.2"},dataProvider="DP",priority=-1)
//    public void test0DayRetentionOnFullPathAndMonthlyData(Bundle bundle) throws Exception
//    {
//     
//        try {
//            //make sure the feed has full path
...
//    
//    @Test(groups = {"0.1","0.2"},dataProvider="DP",priority=-1)
//    public void test10080MinuteRetentionOnFullPathAndMonthlyData(Bundle bundle) throws Exception
//    {
//        try {
//        //make sure the feed has full path
//        String feed=setFeedPathValue(Util.getInputFeedFromBundle(bundle),"/retention/testFolders/${YEAR}/${MONTH}");
...
//    
//    @Test(groups = {"0.1","0.2"},dataProvider="DP",priority=-1)
//    public void test2160MinutesRetentionOnFullPathAndMonthlyData(Bundle bundle) throws Exception
//    {
//        try {
//        //make sure the feed has full path
//        String feed=setFeedPathValue(Util.getInputFeedFromBundle(bundle),"/retention/testFolders/${YEAR}/${MONTH}");
...
//    
//    @Test(groups = {"0.1","0.2"},dataProvider="DP",priority=-1)
//    public void test1440MinuteRetentionOnFullPathAndMonthlyData(Bundle bundle) throws Exception
//    {
//        try {
//        //make sure the feed has full path
//        String feed=setFeedPathValue(Util.getInputFeedFromBundle(bundle),"/retention/testFolders/${YEAR}/${MONTH}");
...
//    
//    @Test(groups = {"0.1","0.2"},dataProvider="DP",priority=-1)
//    public void test60MinutesRetentionOnFullPathAndMonthlyData(Bundle bundle) throws Exception
//    {
//        try {
//        //make sure the feed has full path
//        String feed=setFeedPathValue(Util.getInputFeedFromBundle(bundle),"/retention/testFolders/${YEAR}/${MONTH}");
...
//    
//    @Test(groups = {"0.1","0.2"},dataProvider="DP",priority=-1)
//    public void test0MinuteRetentionOnFullPathAndMonthlyData(Bundle bundle) throws Exception
//    {
//        try {
//        //make sure the feed has full path
//        String feed=setFeedPathValue(Util.getInputFeedFromBundle(bundle),"/retention/testFolders/${YEAR}/${MONTH}");
...
//    
//    @Test(groups = {"0.1","0.2"},dataProvider="DP",priority=-1)
//    public void test0HourlyRetentionOnFullPathAndMonthlyData(Bundle bundle) throws Exception
//    {
//        try {
//        //make sure the feed has full path
//        String feed=setFeedPathValue(Util.getInputFeedFromBundle(bundle),"/retention/testFolders/${YEAR}/${MONTH}");
...
//    
//    @Test(groups = {"0.1","0.2"},dataProvider="DP",priority=-1)
//    public void test168HourlyRetentionOnFullPathAndMonthlyData(Bundle bundle) throws Exception
//    {
//        try {
//        //make sure the feed has full path
//        String feed=setFeedPathValue(Util.getInputFeedFromBundle(bundle),"/retention/testFolders/${YEAR}/${MONTH}");
...
//    
//    @Test(groups = {"0.1","0.2"},dataProvider="DP",priority=-1)
//    public void test48HourlyRetentionOnFullPathAndMonthlyData(Bundle bundle) throws Exception
//    {
//        try {
//        //make sure the feed has full path
//        String feed=setFeedPathValue(Util.getInputFeedFromBundle(bundle),"/retention/testFolders/${YEAR}/${MONTH}");
...
//    
//    @Test(groups = {"0.1","0.2"},dataProvider="DP",priority=-1)
//    public void test24HourlyRetentionOnFullPathAndMonthlyData(Bundle bundle) throws Exception
//    {
//        try {
//        //make sure the feed has full path
//        String feed=setFeedPathValue(Util.getInputFeedFromBundle(bundle),"/retention/testFolders/${YEAR}/${MONTH}");
...
//    
//    @Test(groups = {"0.1","0.2"},dataProvider="DP",priority=-1)
//    public void test36HourlyRetentionOnFullPathAndMonthlyData(Bundle bundle) throws Exception
//    {
//        try {
//        //make sure the feed has full path
//        String feed=setFeedPathValue(Util.getInputFeedFromBundle(bundle),"/retention/testFolders/${YEAR}/${MONTH}");
...
//
//    @Test(groups = {"0.1","0.2"},dataProvider="DP",priority=-1)
//    public void test6HourlyRetentionOnFullPathAndMonthlyData(Bundle bundle) throws Exception
//    {
//        try {
//        //make sure the feed has full path
//        String feed=setFeedPathValue(Util.getInputFeedFromBundle(bundle),"/retention/testFolders/${YEAR}/${MONTH}");
...
//        {
//            if(location.getType().equals("data"))
//            {
