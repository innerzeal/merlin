...
import com.inmobi.qa.airavatqa.generated.feed.Clusters;
...
import com.inmobi.qa.airavatqa.generated.feed.RetentionType;
...
public class Bundle {
	...
	private String injectNewDataIntoFeed(String dataset,String uniqueCluster,String oldCluster) throws Exception
	{
		...
		for(com.inmobi.qa.airavatqa.generated.feed.Cluster cluster:feedElement.getClusters().getCluster())
		{
	...
	private String injectNewDataIntoProcess(String processData,String oldDataName,String newDataName,String uniqueCluster,String oldCluster) throws Exception
	{
		...
		//		for(com.inmobi.qa.airavatqa.generated.Cluster cluster:processElement.getClusters().getCluster())
		//		{
		//			if(cluster.getName().equalsIgnoreCase(oldCluster))
		//			{
		//				cluster.setName(uniqueCluster);
	...
	public void setProcessClusterValidity(String clusterName,String startDate, String endDate) throws Exception
	{
		...
		for(Cluster cluster:processElement.getClusters().getCluster())
		{
			...
			{
				com.inmobi.qa.airavatqa.generated.process.Validity newValidity=new com.inmobi.qa.airavatqa.generated.process.Validity();
				if(startDate!=null)
				{
	...
	//		if(startDate!=null)
	//                {
	//                    processElement.getValidity().setStart(startDate);
	//                }
	//                if(endDate!=null)
	//                {
	//                    processElement.getValidity().setEnd(endDate);
	//                }
	//		java.io.StringWriter sw = new StringWriter();
	//		Marshaller marshaller = jc.createMarshaller();
	//		marshaller.setProperty(Marshaller.JAXB_ENCODING, "UTF-8");
	...
	//                }
	//                
	//                verifyBundleCoordinatorDeletion();
	//
	//	}   
	...
	public com.inmobi.qa.airavatqa.generated.cluster.Cluster getClusterObject() throws Exception
	{
		JAXBContext context=JAXBContext.newInstance(com.inmobi.qa.airavatqa.generated.cluster.Cluster.class);
		Unmarshaller um=context.createUnmarshaller();
		return (com.inmobi.qa.airavatqa.generated.cluster.Cluster)um.unmarshal(new StringReader(getClusterData()));
	}
	...
	public void setProcessValidity(DateTime startDate, DateTime endDate,String clusterName) throws Exception
	{
		...
		for(Cluster cluster:processElement.getClusters().getCluster())
		{
			if(cluster.getName().equalsIgnoreCase(clusterName))
			{
				com.inmobi.qa.airavatqa.generated.process.Validity validity=new com.inmobi.qa.airavatqa.generated.process.Validity();
	...
	public void setCLusterColo(String colo) throws Exception {
		com.inmobi.qa.airavatqa.generated.cluster.Cluster c = instanceUtil.getClusterElement(this);
		c.setColo(colo);
	...
	public void setCLusterWorkingPath(String clusterData , String path)throws Exception  {
		...
		com.inmobi.qa.airavatqa.generated.cluster.Cluster c  = instanceUtil.getClusterElement(clusterData);
	...
	public void addClusterToBundle(String clusterData,ClusterType type) throws Exception
	{
		...
		for(int i=0;i<dataSets.size();i++)
		{
			...
			com.inmobi.qa.airavatqa.generated.feed.Cluster cluster=new com.inmobi.qa.airavatqa.generated.feed.Cluster();
		...
		com.inmobi.qa.airavatqa.generated.process.Cluster cluster=new com.inmobi.qa.airavatqa.generated.process.Cluster();
		cluster.setName(Util.getClusterObject(clusterData).getName());
	...
	{
		com.inmobi.qa.airavatqa.generated.cluster.Cluster clusterObj=Util.getClusterObject(clusterData);
	...
	throws Exception{
		...
		com.inmobi.qa.airavatqa.generated.cluster.Cluster c = instanceUtil.getClusterElement(Util.generateUniqueClusterEntity(b.getClusters().get(0)));
	...
	public String setProcessClusters(String process,List<String> newClusters,String startTime,String endTime) throws Exception{
		...
		Process p = instanceUtil.getProcessElement(process);
		com.inmobi.qa.airavatqa.generated.process.Clusters cs = new com.inmobi.qa.airavatqa.generated.process.Clusters();
	...
	public String setFeedClusters(String referenceFeed,
		...
		for(int i = 0 ; i < newClusters.size() ; i++){
			com.inmobi.qa.airavatqa.generated.feed.Cluster c = new com.inmobi.qa.airavatqa.generated.feed.Cluster();
			c.setName(Util.readClusterName(newClusters.get(i)));
			Location l = new Location();
			l.setType(LocationType.DATA);
